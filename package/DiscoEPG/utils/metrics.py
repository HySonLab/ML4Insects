...
def scoring(true_label, predicted_label):
    ...
    acc = np.round(accuracy_score(true_label,predicted_label)*100,2)
    f1 = np.round(f1_score(true_label, predicted_label, average= 'macro',zero_division = 0)*100,2)
    precision = np.round(precision_score(true_label, predicted_label, average= 'macro',zero_division = 0)*100,2)
    recall = np.round(recall_score(true_label, predicted_label, average= 'macro',zero_division = 0)*100,2) 
